; cspell:disable
; made by Deo - https://apathysoftworks.com/ahk/index.html
...
_BITMAPtoDIB_cleanup:
  ...
  GetHtml()
  {
    ...
    if !( out_size := this._getFormatData( out_data, clipData, clipSize, "HTML Format" ) )
      return ""
    ; return UTF-8 instead of CP0 (Ansi) - RL 21.03.2021
  ...
  iGetHtml()
  {
    ...
    if !( out_size := this._getFormatData( out_data, clipData, clipSize, "HTML Format" ) )
      return ""
    ; return UTF-8 instead of CP0 (Ansi) - RL 30.03.2021
    return strget( &out_data, out_size, "UTF-8" )
  }
